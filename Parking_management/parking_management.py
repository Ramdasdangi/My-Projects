...
mydb=mysql.connector.connect(host="localhost",user="root" ,password='jnv@1988',database='parking')
...
def Vehicle_View():
    ...
    sql='select parkmaster12.pid,parkmaster12.pnm,parkmaster12.vehicleno, vehicle.vid, vehicle.vnm from parkmaster12 INNER JOIN vehicle ON parkmaster12.vehicleno=vehicle.vid and vehicle.vid=%s'
    rl=(vid1,)
